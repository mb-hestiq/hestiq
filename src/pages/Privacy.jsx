	...
	return (
		<>
			...
			<main className="document">
				...
				<p>
					This Privacy Policy describes how HestiQ (the "Site", "we", "us", or
					"our") collects, uses, and discloses your personal information when
					you visit, use our services, or make a purchase from
					https://www.hestiq.com (the "Site") or otherwise communicate with us
				...
				<ul>
					<li>
						...
						any returns and exchanges and to enable you topost reviews.
					</li>
					<li>
				...
				<ul>
					...
					<li>
						...
						products or through youruse of social media widgets or login
				...
				<p>
					...
					these sites. Information you provide on public or semipublic venues,
